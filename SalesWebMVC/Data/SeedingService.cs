    ...
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                ...
                _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT master.dbo.Department ON;");
                _context.SaveChanges();
                _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT master.dbo.Department OFF");

                
                _context.Seller.AddRange(s1, s2, s3, s4, s5, s6);
                _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT master.dbo.Seller ON;");
                _context.SaveChanges();
                _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT master.dbo.Seller OFF;");
                ...
                _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT master.dbo.SalesRecord ON;");
                _context.SaveChanges();
                _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT master.dbo.SalesRecord OFF;");
